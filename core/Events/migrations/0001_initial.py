# Generated by Django 5.0.4 on 2024-05-15 11:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interest', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='Events.interests')),
            ],
        ),
        migrations.AddField(
            model_name='event',
            ...
            field=models.ManyToManyField(
                related_name='interests', through='Events.Event_interests', to='Events.interests'),
        ),
        migrations.CreateModel(
            name='User_interest',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_qrid', models.ImageField(
                    upload_to='Events/static/user_qr_images')),
                ('rating', models.IntegerField(default=0)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.',
                 related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('interest', models.ManyToManyField(
                    through='Events.User_interest', to='Events.interests')),
                ('status', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.CASCADE, to='Events.status')),
        ...
        migrations.AddField(
            ...
            name='member',
            field=models.ManyToManyField(
                related_name='members', through='Events.Members_event', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='event',
            name='organizer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                    related_name='organizer', to=settings.AUTH_USER_MODEL),
        ),
    ]
